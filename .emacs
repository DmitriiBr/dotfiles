...
(custom-set-variables
 ...
 '(package-selected-packages
   '(evil-collection gcmh doom-themes apropospriate-theme utop which-key smartparens general ivy-prescient flymake tao-theme json-mode js2-mode web-mode tuareg mood-line doom-modeline move-text evil projectile counsel lsp-ui smex lsp-mode helm-ls-git helm-git-grep helm exec-path-from-shell company add-node-modules-path apheleia tree-sitter-langs tree-sitter gruber-darker-theme typescript-mode ivy)))
(custom-set-faces
